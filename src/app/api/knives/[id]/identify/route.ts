  ...
  try {
    ...
    const { data: updated, error: updateError } = await supabase
      ...
      .update({
        ...
        model_number_confidence: identification.model_number_confidence,
        ...
        year_start: identification.year_start,
        year_end: identification.year_end,
        year_confidence: identification.year_confidence,
        ...
        ai_model_number: identification.model_number,
        ai_blade_steel: identification.blade_steel,
        ai_handle_material: identification.handle_material,
        ai_year_start: identification.year_start,
        ai_year_end: identification.year_end,
